# -*- coding: utf-8 -*-
"""
Интерактивный скрипт для обучения и использования
системы атрибуции рукописей.
Этот файл вызывает функции из основного модуля handwriting_attribution.py.
"""
...
def run_prediction():
    """
    Запускает процесс предсказания на основе обученной модели.
    """
...
def main():
    """
    Главная функция, отображающая меню и управляющая выбором пользователя.
    """
    if len(sys.argv) > 1:
